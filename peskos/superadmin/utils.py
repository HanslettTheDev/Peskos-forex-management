...
time_type = {"weekly": 4, "monthly": 19, "yearly": 239}
...
def checkrecords(client: Clients, ticket_type: str):
    ...
    client_records = TradingRecords.query.filter_by(
    ...
    if not vclient:
        ...
        tpay = TradingRecords.query.filter_by(
            account_number=client.account_number, date_entered=paydays[-1]
        ).first()
        return tpay
